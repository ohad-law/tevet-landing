...
function buildDay3(name: string): string {
  return [
    ...
    `בדקנו אלפי תלושים. ב-9 מתוך 10 מקרים מצאנו ליקויים.`,
    ``,
    `שלח לי 2-3 תלושים אחרונים ואחזור אליך תוך 24 שעות עם בדיקה ראשונית ללא עלות.`,
    `אם נמצא ליקויים, אציג לך מה מגיע לך ומה עלות הליווי. אתה מחליט.`,
    ``,
    `⚠️ שים לב: תביעות שכר מתיישנות. ככל שמחכים, חלק מהכסף הולך לאיבוד.`,
    ``,
    `הכל חסוי 🔒`,
  ].join('\n')
}
