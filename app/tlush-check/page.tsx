    ...
    <div className={s.page}>
      ...
      <div className={s.wrap}>
        ...
        <div className={s.block}>
          ...
          */}
          <p className={s.sub}>
            בדיקה שמגלה בדיוק כמה כסף חסר לכם בתלושי השכר, לפי
            מספר שנות הוותק שתבחרו.{" "}
            <strong>אם לא נמצא, הכסף חוזר.</strong>
          </p>
        ...
        */}
        ...
        <div className={`${s.block} ${s.hair}`}>
          ...
          {/*
            🚨 היקף העבודה שווה למה שנקנה, ולא למקסימום התיאורטי.
            בלי המשפט הזה לקוח שקנה שלוש שנים מצפה לשבע.
          */}
          <p className={s.p} style={{ marginTop: "1.6rem" }}>
            המחיר הוא <strong>297 ש&quot;ח לכל שנת ותק</strong>, וניתן
            לפרוס עד שלושה תשלומים.{" "}
            <strong>מה שתבחרו זה מה שנבדק:</strong> שילמתם על שלוש
            שנים, נבדקות שלוש שנים. אפשר לחזור עד שבע שנים אחורה,
            כי זו תקופת ההתיישנות.
          </p>
        </div>
