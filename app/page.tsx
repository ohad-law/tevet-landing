        ...
        <div className="container" style={{ textAlign: "center" }}>
          ...
          <div className="steps">
            ...
            <div className="step">
              ...
              <p>תדע כמה כסף חסר לך ומה ניתן לתבוע. ייעוץ ראשוני, ללא התחייבות.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="faq-list">
            <div className="faq-item">
              ...
              <div className="faq-a">
                הבדיקה הראשונית היא <strong>ללא התחייבות</strong>. עו&quot;ד טבת בודק, מנתח ומחזיר לך תמונה ברורה על מה שמגיע לך.
                <br /><br />
